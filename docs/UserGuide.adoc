...
Filters people in your contact list whom you owe or lend money to. +
...
* `people filter debt`
Returns a list of people whom you owe money to. +
Expected Outcome:
...
* `people filter loan`
Returns a list of people whom you lend money to. +
Expected Outcome:
